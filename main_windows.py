...
url = f"http://www.google.com/search?q=+%22{jobTitle}%22+%22{location}%22+%22Cybersecurity%22 -intitle:%22profiles%22 -inurl:%22dir/%22 +site:in.linkedin.com/in/ OR site:in.linkedin.com/pub/&num=500"
...
with open(filename, "w", newline="", encoding="utf-8") as file:
    ...
    for link, name, bio, cybercheck in zip(links, names, bios, cyberchecks):
        writer.writerow([link, name, bio, cybercheck])
